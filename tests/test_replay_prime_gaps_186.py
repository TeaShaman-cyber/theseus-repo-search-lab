...
from scripts.replay_prime_gaps_186 import run_replay
...
def chunk(hint: str, text: str, line: int, commit: str) -> SourceChunk:
    ...
    return SourceChunk(
        id=f"src:PrimeGaps186.lean:{line}:{end}",
        source_commit=commit,
        source_path="PrimeGaps186.lean",
    ...
    write_artifact(
        ...
        sources=[
            chunk(
                ...
                "/-- The lower limit of consecutive prime gaps is at most 186. -/\n"
                "theorem primeGapLiminf_le_186 : True := by trivial\n",
                100,
                source.source_commit,
            ),
            chunk(
                "infinite_two_prime_translates_admissibleTuple",
                "theorem infinite_two_prime_translates_admissibleTuple : True := by trivial\n",
                120,
                source.source_commit,
            ),
        ],
...
class ReplayPrimeGaps186Tests(unittest.TestCase):
